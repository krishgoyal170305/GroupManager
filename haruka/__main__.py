...
Made by  [@krishgoyal_xD](t.me/krishgoyal_xd)

Special thanks to [this person](t.me/sixteenbit1) for helping me.


Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/groupmanagingrobot?startgroup=true).
"""
...
keyboard = [[InlineKeyboardButton(text="ADD ME IN GROUP", callback_data="http://t.me/groupmanagingrobot?startgroup=true")]]
